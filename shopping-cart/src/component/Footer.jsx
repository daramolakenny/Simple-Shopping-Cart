  ...
  return (
    <div className='w-full bg-violet-600 text-white py-8 rounded-t-sm shadow-2xl gap-4'>
      <div className='flex flex-col md:flex md:flex-row justify-around mb-10 pl-6 gap-4'>
        <div>
          <h1 className='text-2xl pb-4'>Shop<span className='underline text-red-400'>ty</span></h1>
          ...
          <div className='flex gap-3 py-2'>
            ...
            <div>
              <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" class="w-6 h-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334q.002-.211-.006-.422A6.7 6.7 0 0 0 16 3.542a6.7 6.7 0 0 1-1.889.518 3.3 3.3 0 0 0 1.447-1.817 6.5 6.5 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.32 9.32 0 0 1-6.767-3.429 3.29 3.29 0 0 0 1.018 4.382A3.3 3.3 0 0 1 .64 6.575v.045a3.29 3.29 0 0 0 2.632 3.218 3.2 3.2 0 0 1-.865.115 3 3 0 0 1-.614-.057 3.28 3.28 0 0 0 3.067 2.277A6.6 6.6 0 0 1 .78 13.58a6 6 0 0 1-.78-.045A9.34 9.34 0 0 0 5.026 15"></path></svg>
            </div>
            ...
            <div>
              <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 488 512" class="w-6 h-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path></svg>
            </div>
          </div>
        </div>
        ...
        <div>
          <h1>Stay Updated</h1>
          <form action="" className='flex flex-col w-[430px] gap-2'>
            <input 
              type="text" 
